export interface User {
  ...
  username: string;
  token?: string;
  role?: string; // Optional: for backward compatibility with role-based UI
  // Note: users now have roles per project via ProjectMember
}
...
export interface AddSceneNoteRequest {
  text: string;
  role: string;
}
