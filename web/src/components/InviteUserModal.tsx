...
const AVAILABLE_ROLES: {
  ...
  },
  {
    value: "scout",
    label: "Scout",
    description: "Find and recommend locations",
  },
  {
    value: "crew",
    label: "Crew",
...
const InviteUserModal: React.FC<InviteUserModalProps> = ({
  ...
  const [selectedRoles, setSelectedRoles] = useState<ProjectRole[]>(["crew"]);
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-gray-500">
              Selected: {selectedRoles.length} role
            ...
            <div className="flex items-start">
              ...
              <div className="text-sm text-blue-800">
                ...
                <p className="text-blue-700">
                  The user will receive an invitation that they can accept or
                  decline. Invitations expire after 7 days.
                </p>
              </div>
            </div>
          </div>
